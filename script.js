function showMovies (keyword =  "" ) {
  const keywordReplaced = keyword.trim().toLowerCase();


  const dataMovies = getMovies(keywordReplaced);
  console.log(dataMovies)
const listMoviesDOM = document.getElementById("list-movies");
let dataMoviesDOM = ""
...
listMoviesDOM.innerHTML = dataMoviesDOM;
